...
public class PlayerPanelController : MonoBehaviour
{
    ...
    public void AddHP()
    {
        if(_mainData.Money >= _dataOfPlayerPanel.CurrentPriceOfHP)
        {
            ...
            _mainData.PlayersShip.GetComponent<PlayerData>().Health += numberWhichAddToShieldAndHP;
    ...
    public void AddShield()
    {
        if (_mainData.Money >= _dataOfPlayerPanel.CurrentPriceOfShield)
        {
            ...
            _mainData.PlayersShip.GetComponent<PlayerData>().Shield += numberWhichAddToShieldAndHP;
